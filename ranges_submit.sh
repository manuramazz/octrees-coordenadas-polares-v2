...
#SBATCH --mem=25G            # Memoria RAM (ajusta según el peso de Semantic3D)
#SBATCH -t 00:10:00          # Tiempo máximo (HH:MM:SS)
#SBATCH -J debug_octree_ranges_v9    # Nombre del trabajo
