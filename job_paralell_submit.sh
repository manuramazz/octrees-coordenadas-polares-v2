...
#SBATCH -t 08:00:00          # Tiempo máximo (HH:MM:SS)
#SBATCH -J out_tfg_parallel    # Nombre del trabajo
...
chmod +x bench_neighbors_parallel.bash

echo "Iniciando benchmark"
echo "Fecha: $(date)"

bash bench_neighbors_parallel.bash
