...
En la Figuras \ref{fig:fullSearches_grupo1} a \ref{fig:fullSearches_grupo3} se
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{figuras/full/5085.png} 
    \vspace{0.3cm}
    \includegraphics[width=0.95\textwidth]{figuras/full/pnoa.png} 
    \caption{Tiempos de ejecución de búsquedas completas variando el radio operativo sobre kernels esféricos y cúbicos para los datasets \textit{5085\_54320} (a) y \textit{PNOA\_2024\_PNR\_489-4672\_NPC01} (b).}
    \label{fig:fullSearches_grupo1}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{figuras/full/mar18train.png} 
    \vspace{0.3cm}
    \includegraphics[width=0.95\textwidth]{figuras/full/paris.png} 
    \caption{Tiempos de ejecución de búsquedas completas variando el radio operativo sobre kernels esféricos y cúbicos para los datasets \textit{Mar18\_train} (a) y \textit{Paris\_Luxembourg\_6} (b).}
    \label{fig:fullSearches_grupo2}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{figuras/full/bild.png} 
    \caption{Tiempos de ejecución de búsquedas completas variando el radio operativo sobre kernels esféricos y cúbicos para el dataset \textit{bildstein\_station1}.}
    \label{fig:fullSearches_grupo3}
\end{figure}
