...
#SBATCH -t 00:15:00          # Tiempo máximo (HH:MM:SS) - sube a 12h si el full search es lento
#SBATCH -J prueba_nubes    # Nombre del trabajo
...
chmod +x bench_neighbors_prueba.bash

echo "Iniciando benchmark"
echo "Fecha: $(date)"

bash bench_neighbors_prueba.bash
